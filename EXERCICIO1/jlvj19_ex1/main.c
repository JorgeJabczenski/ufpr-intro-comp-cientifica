...
OBS: os intervalos inválidos e overflow e underflow são checados ANTES de imprimir qualquer coisa,
portanto caso isso aconteça o programa não irá imprimir nada, para desativar essa checagem é só 
...
/* Ativa o ambiente float, aparece como warning quando compilando com -Wall */
